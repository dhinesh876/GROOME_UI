...
//     <>
//       <h1 className="dash-heading">Manage shop</h1>
//       <p className="ms-dash-subheading">Add or remove services and employees.</p>

//       {error && <p className="ms-auth-error">{error}</p>}
...
export default function ManageShop({ shop, onChanged }) {
  ...
  return (
    <>
      ...
      <p className="ms-dash-subheading">
        Add or remove services and employees.
      </p>

      {error && (
        <p className="ms-auth-error">
          {error}
        </p>
      )}
            ...
            {/* {(shop.employees || []).map((emp) => (
              ...
              >
                ...
                <div className="employee-top">
                  ...
                  <div className="ms-employee-avatar">
                    {emp.name.charAt(0).toUpperCase()}
                  </div>
                ...
                <div className="ms-employee-services">
