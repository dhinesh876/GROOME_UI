...
// import { Calendar, Check, Clock, Mail, Phone, Scissors, UserCog, X, XCircle } from "lucide-react";
...
//           </div>
//         ) : (<form
//           className="sod-dash-form"
//           onSubmit={handleRegisterShop}
//         >

//           <h2 className="sod-dash-heading">
//             Register Shop
//           </h2>

//           {/* Shop Image */}

//           <div className="sod-dash-field">
...
//             <div className="sod-day-pill-row">
...
//                     type="button"
//                     key={day}
//                     className={`sod-day-pill ${active ? "active" : ""
//                       }`}
//                     onClick={() =>
//                       toggleDay(day)
//                     }
...
//                 <div className="sod-employee-services">
...
//                         <div className="sod-employee-avatar">
...
//               <div className="sod-appt-empty">

//                 <div className="sod-appt-empty-icon">
//                   <Calendar size={28} />
//                 </div>
...
//                   <div
//                     className="sod-appt-card"
//                     key={appointment.appointmentId}
//                   >

//                     {/* Top: avatar + name/contact + status */}

//                     <div className="sod-appt-top">

//                       <div className="sod-appt-customer">

//                         <div className="sod-appt-avatar">
//                           {appointment.customer?.name?.charAt(0).toUpperCase() || "?"}
//                         </div>

//                         <div>

//                           <h3 className="sod-appt-name">
//                             {appointment.customer?.name}
//                           </h3>

//                           <div className="sod-appt-contact">
...
//                       <span
//                         className={`sod-status-badge status-${appointment.status
//                           .toLowerCase()
//                           .replace(/\s+/g, "-")}`}
//                       >
//                         {appointment.status}
...
//                     {/* Meta: date / time / employee */}

//                     <div className="sod-appt-meta">

//                       <div className="sod-appt-meta-item">
//                         <Calendar size={15} />
...
//                     <div className="sod-appt-services-row">

//                       <span className="sod-appt-services-label">
//                         <Scissors size={14} />
//                         Services
//                       </span>
...
//                     <div className="sod-appt-footer">

//                       <div className="sod-appt-total">
//                         <span>Total</span>
//                         <strong className="price-value">₹{appointment.totalPrice}</strong>
//                       </div>
